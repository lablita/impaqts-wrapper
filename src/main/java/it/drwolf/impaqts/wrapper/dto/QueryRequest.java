...
public class QueryRequest {
	...
	public enum RequestType {
		VISUAL_QUERY_REQUEST, TEXTUAL_QUERY_REQUEST, CONTEXT_QUERY_REQUEST, COLLOCATION_REQUEST, QUICK_SORT_REQUEST, MULTI_FREQUENCY_QUERY_REQUEST, CONC_FREQUENCY_QUERY_REQUEST, PN_FREQUEQUENCY_CONCORDANCE_QUERY_REQUEST, WIDE_CONTEXT_QUERY_REQUEST;
